...
class CAPSError(Exception):
   ...
   cOCSM.OCSM_PMTR_IS_DESPMTR             : 'OCSM_PMTR_IS_DESPMTR',    
   cOCSM.OCSM_PMTR_IS_CONPMTR             : 'OCSM_PMTR_IS_CONPMTR',    
   cOCSM.OCSM_PMTR_IS_OUTPMTR             : 'OCSM_PMTR_IS_OUTPMTR',    
   cOCSM.OCSM_PMTR_IS_LOCALVAR            : 'OCSM_PMTR_IS_LOCALVAR',    
