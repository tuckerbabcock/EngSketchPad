...
class TestProblem(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        if os.path.exists(cls.analysisDir1):
            os.rmdir(cls.analysisDir1)

        if os.path.exists(cls.analysisDir2):
            os.rmdir(cls.analysisDir2)
...
#=============================================================================-
    def test_openSingleParametric(self):
        ...
        self.assertEqual("TestProblem"        , name)
...
#=============================================================================-
    def test_makeAnalysis(self):
        ...
        analysis1 = problem.makeAnalysis("fun3dAIM", name = None, unitSys=None, analysisDir=self.analysisDir1)
        analysis2 = problem.makeAnalysis("fun3dAIM", name = None, unitSys=None, analysisDir=self.analysisDir2)
...
#=============================================================================-
    def test_makeValue(self):
        ...
        data = ("Hello", "World")
        value = problem.makeValue("tuple", caps.sType.USER, data)
        data_out = value.getValue()
        self.assertEqual(data, data_out)

        data = [("Hello", "World"), ("World", "Hello")]
        value = problem.makeValue("listtuple", caps.sType.USER, data)
        data_out = value.getValue()
        self.assertEqual(data, data_out)
