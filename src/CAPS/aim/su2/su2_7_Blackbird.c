...
// Write SU2 configuration file for version Blackbird (7.0.7)
int su2_writeCongfig_Blackbird(void *aimInfo, const char *analysisPath, capsValue *aimInputs, cfdBCsStruct bcProps, int withMotion) {
    ...
    printf("Write SU2 configuration file for version \"BlackBird (7.0.7) \"\n");
    ...
    fprintf(fp,"%% File Version 7.0.7 \"Blackbird\"                                               %%\n");
    fprintf(fp,"%%                                                                              %%\n");
    ...
    int compare = strcmp("COMPRESSIBLE", aimInputs[aim_getIndex(aimInfo, "Equation_Type",  ANALYSISIN)-1].vals.string);
    if(compare == 0 ) {
    ...
    fprintf(fp,"%% \n");
    fprintf(fp,"%% Visualize the surface deformation (NO, YES) \n");
    fprintf(fp,"VISUALIZE_SURFACE_DEF= YES \n");
    fprintf(fp,"%% \n");
    fprintf(fp,"%% Visualize the volume deformation (NO, YES) \n");
    ...
    fprintf(fp,"OUTPUT_FILES= RESTART, %s, SURFACE_%s\n", aimInputs[aim_getIndex(aimInfo, "Output_Format",  ANALYSISIN)-1].vals.string, aimInputs[aim_getIndex(aimInfo, "Output_Format",  ANALYSISIN)-1].vals.string);
    fprintf(fp,"%% \n");
