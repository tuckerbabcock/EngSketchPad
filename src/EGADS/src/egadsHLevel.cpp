 ...
 * - The 2 connected edges must have the same underlying geometry, or reside on two G1 continuous spline CURVES
                       ...
                       TopoDS_Shape& result, TopoDS_Shape& newShape)
{
  ...
  /* get all the vertexes in the result */
  ...
  /* remove all Vertexes in the tool/argument from the list
   * as well as any Generated/Modified Vertexes
   */
  for (iarg = 0; iarg < 2; iarg++) {
    ...
    for (; iter.More(); iter.Next()) {
      ...
      /* first remove all vertexes associated with edges */
      ...
      for (i = 0; i < MapEs.Extent(); i++) {
        ...
        /* remove Vertexes from Modified/Generated Edges/Vertexes */
        for (m = 0; m < 2; m++) {
      ...
      /* removing Vertexes generated by Faces */
  ...
  /* MapVdel now contains the vertexes that are
