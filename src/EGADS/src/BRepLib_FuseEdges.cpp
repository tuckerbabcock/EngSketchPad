...
//=======================================================================
//function : AvoidVertexes
//purpose  : set vertexes to avoid being fused
//=======================================================================

void BRepLib_FuseEdges::AvoidVertexes(const TopTools_IndexedMapOfShape& theMapVert)
{
  myAvoidVert = theMapVert;
}
...
{
  if (myAvoidVert.Contains(theVertex))
     return Standard_False;       // vertex is not allowed to be fused
