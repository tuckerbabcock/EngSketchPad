...
class TestGeometry(unittest.TestCase):
    ...
    def test_getAttributeVal(self):
        ...
        leftWingSkin = [ 3.77246051677845 ,  0               ,  0.004591314188236,
                        ...
                        -0.447066579176242, -7.07106781186547, -0.365374367002283]
        for i in range(9):
    ...
    def test_getGeometryOutVal(self):
        ...
        self.assertEqual(valueDict["dummyRow2"],[1,2,2])
        
        # FIXME
        self.assertEqual(valueDict["dummyRow3"],[2,3,1,1,1])
    ...
    # Try initiating the geometry object directly 
    def test_geometryInit(self):
        
        myProblem = pyCAPS.capsProblem()

        myGeometry = pyCAPS.capsGeometry( myProblem, self.file, "basicTest")
        
        self.assertEqual(myGeometry, myProblem.geometry)
    
    # Try initiating the geometry object directly with wrong object
    def test_geometryInit2(self):
        
        with self.assertRaises(TypeError) as e:
            myProblem = pyCAPS.capsProblem()
            pyCAPS.capsGeometry( "myProblem", self.file, "basicTest")
    ...
    def test_getBoundingBox(self):
        ...
        box = self.myGeometry.getBoundingBox()
