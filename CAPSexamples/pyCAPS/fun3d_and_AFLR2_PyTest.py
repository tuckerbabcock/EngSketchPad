...
myProblem.geometry.saveGeometry("GenericShape", directory = workDir, extension = "egads")

# Load aflr2 aim
myProblem.loadAIM(aim = "aflr2AIM", analysisDir = workDir)

myProblem.analysis["aflr2AIM"].setAnalysisVal("Mesh_Sizing", [("Airfoil"   , {"numEdgePoints" : 400}),
