...
parser = argparse.ArgumentParser(description = 'Aeroelastic SU2 and Astros Example',
                                 prog = 'aeroelasticSimple_Iterative_SU2_and_Astros',
...
workDir = os.path.join(str(args.workDir[0]), "AeroelasticSimple_Iterative_SA")
...
myProblem.analysis["egads"].setAnalysisVal("Tess_Params", [.3, 0.01, 20.0])
...
myProblem.analysis["astros"].setAnalysisVal("Tess_Params", [.2, .1, 15])
