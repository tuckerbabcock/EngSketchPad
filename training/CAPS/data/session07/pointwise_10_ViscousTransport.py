...
pointwise = myProblem.loadAIM(aim = "pointwiseAIM",
                              analysisDir = "workDir_10_ViscousTransport")
...
pointwise.setAnalysisVal("Domain_Structure_AR_Convert", 10.0)
