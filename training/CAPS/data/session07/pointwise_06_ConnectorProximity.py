...
# Load CSM file
transport = myProblem.loadCAPS(os.path.join("..","EGADS","CFDInviscid_WingPod.egads"))

# Load pointwise aim
pointwise = myProblem.loadAIM(aim = "pointwiseAIM",
                              analysisDir = "workDir_06_InviscidWingPod")
...
for conSourceSpace in [False, True]:
    ...
    pointwise.setAnalysisVal("Proj_Name", "TransportWingPod_conSourceSpace_" + str(conSourceSpace))
