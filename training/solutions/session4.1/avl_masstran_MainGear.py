...
wing_xroot = transport.getGeometryVal("wing:xroot")
wing_mac = transport.getGeometryOutVal("wing:mac")

maingear_CGx = wing_xroot+0.7*wing_mac
...
Main_gear = {"mass":[4500, "lb"], "CG":[[ maingear_CGx,  0., -4], "ft"], I:[[0.5e6, 0.0, 0.5e6], "lb*ft^2"]}
